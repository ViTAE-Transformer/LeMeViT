...
class Backbone(torch.nn.Module):
    def __init__(self, args, input_nc, output_nc,
                 resnet_stages_num=5,
                 output_sigmoid=False, if_upsample_2x=True, pretrained=None):
        """
        ...
        if args.backbone == 'resnet':
            ...
            from .lemevit import lemevit_tiny, lemevit_small, lemevit_base
            self.backbone = lemevit_small(pretrained=args.pretrained)
            
            # filters0 = [64, 128, 192, 320] 
            filters0 = [96, 192, 320, 384]
            # filters0 = [96, 192, 384, 512]
        else:
